...
parser.add_argument("-t", action="store", dest="test_size", type=float, default=0.33, help="Provide decimal for size of final evaluation test set. Default: 0.33")
...
with open('C:/Users/vinde/OneDrive/Dokumenter/DTU/Algorithms_in_bioinformatics/Project/data.txt', "rb") as new_filename:
